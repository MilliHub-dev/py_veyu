    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mechanic_type', models.CharField(choices=[('business', 'Registered Business'), ('individual', 'Individual Mechanic')], default='business', max_length=50)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='profiles/')),
                ('slug', models.SlugField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(choices=[('motaa', 'Motaa'), ('google', 'Google'), ('facebook', 'Facebook'), ('apple', 'Apple')], default='motaa', max_length=20)),
